...
import gerard.example.munchkinhelper.adapters.HistoryGamesAdapter
import gerard.example.munchkinhelper.adapters.SchemesAdapter
import gerard.example.munchkinhelper.model.Game
import gerard.example.munchkinhelper.model.Scheme
import gerard.example.munchkinhelper.viewmodels.LoadGameVM
...
class LoadGameActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val viewmodel = ViewModelProvider.AndroidViewModelFactory.getInstance(application).create(LoadGameVM::class.java)
