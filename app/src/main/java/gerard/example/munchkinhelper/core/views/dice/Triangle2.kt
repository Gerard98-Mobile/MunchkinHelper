...
import gerard.example.munchkinhelper.core.views.dice.Dice3DView.DiceRenderer.Companion.loadShader
...
class Triangle2 {
    ...
    var triangleCoords = floatArrayOf(     // in counterclockwise order:
        ...
        -0.5f, -0.311004243f, 0.0f,      // top
        0.5f, -0.311004243f, 1.0f,    // bottom left
        0.5f, -0.311004243f, 0.0f, // bottom right
    )

    // Set color with red, green, blue and alpha (opacity) values
    val color = floatArrayOf(0.2f, 0.73f, 0.68f, 1.0f)
